...
"margin-left: 2em;"));
    ...
    void retranslateUi(QWidget *TrackingPage)
    {
        ...
        noneExplanation->setText(QApplication::translate("TrackingPage", "<html><head/><body><p>Click here to send <span style=\" font-weight:600;\">no information at all</span> about your installation.</p></body></html>", nullptr));

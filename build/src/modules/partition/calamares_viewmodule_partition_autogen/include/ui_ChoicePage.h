...
public:
    ...
    void setupUi(QWidget *ChoicePage)
    {
        ...
        pushButton = new QPushButton(ChoicePage);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 723, 324));
        ...
        sizePolicy1.setHeightForWidth(m_previewBeforeFrame->sizePolicy().hasHeightForWidth());
        m_previewBeforeFrame->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(m_previewAfterFrame->sizePolicy().hasHeightForWidth());
        m_previewAfterFrame->setSizePolicy(sizePolicy1);
    ...
    void retranslateUi(QWidget *ChoicePage)
    {
        ...
        pushButton->setText(QApplication::translate("ChoicePage", "Backup", nullptr));
        label->setText(QApplication::translate("ChoicePage", " Click to backup file", nullptr));
    } // retranslateUi
